...
public class jepetStoarReadProperties {
	public static Properties fileRead(){
		
		try{
			FileInputStream stream=new FileInputStream("C:\\Users\\punam\\Desktop\\seleniumAutomation\\jepetstorewithPageFactory.sel.project\\src\\test\\resources\\jepetstorepageFactoryprop.properties");
